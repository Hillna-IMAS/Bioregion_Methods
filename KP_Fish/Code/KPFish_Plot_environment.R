...
# H) Species Archetype Models- site prob from model, plus partial plots
# I) Regions of Common Profile- postprobs from model, plus partial plots
...
contents_SD<-rbind(do.call(rbind, hclust_contents_SD),
                   rcp_post_contents_SD, sam_post_contents_SD)
