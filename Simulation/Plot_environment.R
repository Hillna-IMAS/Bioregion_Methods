...
contents_SD$Method<-contents_SD$Method<-factor(contents_SD$Method, 
                        levels=c("Env_Only", "BioHC_RF", "SpRF_HC", "HMSC_HC", "MNet_HC", 
                                 "GDM_Dissim_HC", "GDM_TransEnv_HC", "bbGDM_Dissim_HC", "bbGDM_TransEnv_HC",
                                 "GF_HC", "SAM_Hard", "RCP_Hard","True_Hard"))
...
contents_SE$Method<-contents_SE$Method<-factor(contents_SE$Method, 
                                               levels=c("Env_Only", "BioHC_RF", "SpRF_HC", "HMSC_HC", "MNet_HC", 
                                                        "GDM_Dissim_HC", "GDM_TransEnv_HC", "bbGDM_Dissim_HC", "bbGDM_TransEnv_HC",
                                                        "GF_HC", "SAM_Hard", "RCP_Hard","True_Hard"))
names(contents_SE)[1:2]<-names(contents_SD)[1:2]<-c("Bioregion","Value")
...
tiff(file="Results/Plots/Grp_env_redSD.tiff", height=8, width=18, units="cm", res=1000)
#tiff(file="Results/Plots/Grp_env_SD.tiff", height=16, width=16, units="cm", res=1000)
p + scale_x_discrete(name="Bioregion", breaks=c(1,2,3), limits=c("1","2", "3"))
dev.off()
